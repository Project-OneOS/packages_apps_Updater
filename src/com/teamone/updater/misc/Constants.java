...
public final class Constants {
    ...
    static final String PROP_DEVICE = "ro.one.device";
    static final String PROP_BUILD_VERSION = "ro.oneos.base.version";
    static final String PROP_VERSION_CODE = "ro.oneos.version";
    static final String OTA_URL = "https://raw.githubusercontent.com/Project-OneOS/Updates/ten-staging/builds/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/Project-OneOS/Updates/ten-staging/changelogs/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/one_updates/";
    static final String EXPORT_PATH = "OneOS-Updates/";
